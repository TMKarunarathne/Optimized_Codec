function decoded_vid_frames_res = decode_opt_video_frames(encoded_vid_frames , row_mac , col_mac )
...
for i = 1:row
    ...
    decoded_vid_frames_res{i,2} = decode_opt_image(encoded_vid_frames(i,:) , row_mac , col_mac ,level );
    % encoded_im=encoded_vid_frames(1,:);
